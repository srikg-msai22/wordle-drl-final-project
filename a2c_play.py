...
def main(
    ...
    _, agent, env = drl_models.a2c.play.load_from_checkpoint(checkpoint)
...
def suggest(agent, env):
    ...
    while True:
        ...
        word_masks = []
        while True:
            guess = drl_models.a2c.play.suggest(agent, env, word_masks)
...
def goal(agent, env):
    ...
    while True:
        ...
        try:
            win, outcomes = drl_models.a2c.play.goal(agent, env, goal_word)
