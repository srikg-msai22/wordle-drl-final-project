...
from drl_models.a2c.agent import GreedyActorCriticAgent
from drl_models.a2c.module import AdvantageActorCritic
from env.wordle import WordleEnvBase
...
def suggest(
    ...
    for word, mask in sequence:
        ...
        state = env.state.update_from_mask(state, word, mask)
